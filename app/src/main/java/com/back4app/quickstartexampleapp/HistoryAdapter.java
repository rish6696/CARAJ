...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryHolder> {
    ...
    public HistoryAdapter(ArrayList<String> subjectList, ArrayList<String> filename, ArrayList<String> urlist, ArrayList<Boolean> imgefromcamera, ArrayList<Date>datelist) {
        SubjectList = subjectList;
        this.filenames = filename;
        this.urlist = urlist;
        this.imgefromcamera = imgefromcamera;
    ...
    public HistoryHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        HistoryHolder myViewHolder=new HistoryHolder(view);
        return myViewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull HistoryHolder holder, int position) {
        ...
        holder.nameoffile.setText(filenames.get(position));
        ...
        holder.filename=filenames.get(position);
                ...
                public void onClick(View view) {
                    if (haveNetworkConnection()) {
                        ...
                        if (getextension(filename).equals("jpg") || getextension(filename).equals("jpeg") || getextension(filename).equals("png")) {
                            ...
                            Userhistoryactivity.progressBar.setVisibility(View.VISIBLE);
